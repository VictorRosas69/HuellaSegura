...
export default function MisMascotas() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: '#0F0F1A' }}>
      ...
      {/* ── Header ─────────────────────────────────────────────────── */}
      <div className="relative px-5 pt-safe pt-5 pb-6 overflow-hidden"
        ...
        <div className="flex items-center justify-between relative z-10">
          <div>
            <h1 className="text-2xl font-poppins font-extrabold text-white">Mis mascotas</h1>
        ...
        <div className="px-4 pt-4 flex flex-col gap-4">
          ...
          {[1, 2, 3].map(i => (
            <div key={i} className="rounded-3xl overflow-hidden"
              ...
              <div className="h-44 animate-pulse" style={{ background: 'rgba(255,255,255,0.08)' }} />
              <div className="p-4 flex flex-col gap-2">
                <div className="h-5 w-32 rounded-xl animate-pulse" style={{ background: 'rgba(255,255,255,0.08)' }} />
                <div className="h-3.5 w-20 rounded-xl animate-pulse" style={{ background: 'rgba(255,255,255,0.06)' }} />
                <div className="flex gap-2 mt-2">
                  <div className="h-10 flex-1 rounded-2xl animate-pulse" style={{ background: 'rgba(255,255,255,0.08)' }} />
                  <div className="h-10 w-10 rounded-2xl animate-pulse" style={{ background: 'rgba(255,255,255,0.08)' }} />
                </div>
              </div>
            </div>
          ))}
      ...
      {!cargando && !error && mascotas.length === 0 && (
        <div className="flex flex-col items-center py-16 px-8 text-center" data-testid="empty-state">
          <div className="h-28 w-28 rounded-3xl flex items-center justify-center text-6xl mb-5"
               style={{ background: 'linear-gradient(135deg,rgba(255,144,128,0.3),rgba(249,123,98,0.3))', border: '1px solid rgba(249,123,98,0.3)' }}>
            🐾
          </div>
          <h3 className="text-lg font-poppins font-bold mb-2 text-white">Aún no tienes mascotas registradas</h3>
